                    ...
                    <table class="table table-hover"> 
                        <tbody>
                            ...
                            <tr id="user_{{$user->id}}">
                                ...
                                <td>@if($user->tipo_contatos_id == 2 )
                                    <a href="https://api.whatsapp.com/send?phone={{$user->contato}}" target="_blank"><img src="../img/whats_invert2_26.PNG" width=”13” height=”12”></img></a>
                                @else
                                    <a href="https://api.whatsapp.com/send?phone={{$user->contato}}"target="_blank"><img src="../img/whats_invert2_26_black.PNG" width=”13” height=”12”></img></a>
                                @endif
                                </td>
									  ...
									  <div class="modal-dialog">                                  
										...
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<p>  
											 Deseja realmente excluir {{ Form::label('','',['class' => 'control-label user_name']) }}?  
											</p>
										  </div>
...
$(document).ready(function(){
    ...
    $('.clique').click(function() {	
		...
		$.get('users/'+id+'/apiNome',function(data){
			$('.user_name').html("<strong>"+data+"</strong>"); 
		}); 
