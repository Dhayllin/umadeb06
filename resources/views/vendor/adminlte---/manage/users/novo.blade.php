            ...
            <div class="box box-success">
              ...
              <div class="box-tools">
                ...
                <div class="panel-body"> 
                    ...
                    <div class="form-group has-feedback">
                    {!! Form::label('tipo_contatos_id','Tipo Contato') !!} 
                    <select class="form-control " data-placeholder="Selecione" style="width: 100%;"name="tipo_contatos_id" id="tipo_contatos_id" >
                        <option value="" >Selecione</option>         
                        @foreach($tipo_contatos as $tipo_contatos_id)  
                            <option value="{{$tipo_contatos_id->id}}" >
                            {{$tipo_contatos_id->descricao_contato}}
                            </option>
                        @endforeach
                    </select>                 
                    </div>  
                    <div class="form-group has-feedback">
                        {!! Form::label('matriz_id','Matriz que o usário pertence?') !!} 
                        <select class="form-control " data-placeholder="Selecione" style="width: 100%;"name="matriz_id" id="matriz_id" >
                            <option value="" >Selecione</option>         
