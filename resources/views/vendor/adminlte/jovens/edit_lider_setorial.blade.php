    ...
    <div class="row">
        <div class="col-md-11">
            <div class="panel panel-default">
                <div class="panel-heading">Editar Joven Setor</div>
                <div class="panel-body">
                    <form method="POST" action="{{ route('updateLiderSetor', $item->id) }}" enctype="multipart/form-data">
                        ...
                        <a href="{{ url('/home') }}" class="btn btn-danger pull-right">Cancelar</a>
                    </form>
                </div>
            </div>
        </div>
